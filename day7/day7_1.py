...
with open('input') as f:
    ...
    dirsWithSizeUnder100_000 = [(dir, get_dir_size(dir, dirContents)) for dir in dirContents if
                                get_dir_size(dir, dirContents) <= 100_000]
    print(dirsWithSizeUnder100_000)
    print(sum(size for dir, size in dirsWithSizeUnder100_000))
